...
<nav class="mobile-nav" id="mobileNav">
  <a href="#home"     onclick="closeMobileNav()">Главная</a>
  <a href="#about"    onclick="closeMobileNav()">О компании</a>
  <a href="#services" onclick="closeMobileNav()">Услуги</a>
  <a href="#catalog"  onclick="closeMobileNav()">Каталог</a>
  <a href="#contacts" onclick="closeMobileNav()">Контакты</a>
  ${State.isAdmin ? `<a href="#admin" onclick="closeMobileNav()">Админ-панель</a>` : ''}
